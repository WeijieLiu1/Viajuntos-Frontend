    ...
    return Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            ...
            FutureBuilder(
                future: getPredictionByLocation(
                    widget.longitud,
                    widget.latitude,
          ...
          Row(children: [
            ...
            FutureBuilder(
                future: getPredictionByLocation(
                    widget.longitud,
                    widget.latitude,
                    afterTomorrow.day.toString(),
                    afterTomorrow.month.toString(),
                    afterTomorrow.year.toString(),
                    afterTomorrow.hour.toString()),
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  if (snapshot.connectionState == ConnectionState.done) {
                    var _airQuality = json.decode(snapshot.data.body);
                    return Container(
